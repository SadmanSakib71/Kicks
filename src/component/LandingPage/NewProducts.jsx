    ...
    <section className="mt-4 mb-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-row items-end justify-between gap-3 sm:gap-4 mb-4 sm:mb-8 px-4 py-4 sm:px-0 sm:py-0 rounded-lg sm:rounded-none">
          ...
          <Link to="/all-new-items">
            <button
              type="button"
              className="cursor-pointer bg-[#4C7AF2] text-white font-semibold uppercase tracking-wide text-xs sm:text-sm px-4 py-2.5 sm:px-6 sm:py-3 rounded-lg sm:rounded-lg hover:bg-[#3d6ae0] transition-colors shrink-0 whitespace-nowrap"
            >
              SHOP NEW DROPS
            </button>
          </Link>
